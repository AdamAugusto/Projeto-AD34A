<div class="container-fluid">
    <div class="row justify-content-center align-items-center col-auto" style="min-height: 670px;">
        <div class="col" style="max-width: 450px;">
            <form class="row needs-validation" >
                ...
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="floatingNick" placeholder="Name" required>
